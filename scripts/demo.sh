...
curl_endpoint '/leaderboard/followers?limit=:limit' '/leaderboard/followers?limit=3'
curl_endpoint '/leaderboard/following?limit=:limit' '/leaderboard/following?limit=3'
curl_endpoint '/lists/:token_id/records?includeTags=:includeTags' '/lists/0/records?includeTags=false'
curl_endpoint '/lists/:token_id/records?includeTags=:includeTags' '/lists/0/records?includeTags=true'
