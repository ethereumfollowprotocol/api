 ...
 */
export function allFollowing(lists: Hono<{ Bindings: Environment }>, services: Services) {
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: <explanation>
  lists.get('/:token_id/allFollowing', includeValidator, async context => {
    ...
    const followingListRecords: FollowingResponse[] = await efp.getAllUserFollowingByListTagSort(
      token_id,
      limit as string,
      offset as string,
      tagsToSearch,
